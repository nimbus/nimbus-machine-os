...
bash "${repo_root}/scripts/build.sh" \
  ...
  --fedora-bootc-base-image quay.io/fedora/fedora-bootc@sha256:5f2aa40538a71e32eba8dcdf9059dda10600bac68acef4588cb1aecedcfc6fe2 \
...
grep -F -- '--fedora-bootc-base-image quay.io/fedora/fedora-bootc@sha256:5f2aa40538a71e32eba8dcdf9059dda10600bac68acef4588cb1aecedcfc6fe2' "${temp_dir}/recipe.log" >/dev/null
